...
kubectl apply -f "C:\Users\t-kritilnu\OneDrive - Microsoft\Desktop\Network policies for hybrid cluster\Setup files\azure-npm-linux.yaml"
kubectl apply -f "C:\Users\t-kritilnu\OneDrive - Microsoft\Desktop\Network policies for hybrid cluster\Setup files\azure-npm-windows.yaml"


wget https://raw.githubusercontent.com/Azure/azure-container-networking/master/npm/examples/windows/azure-npm.yaml -o azure-npm-windows.yaml

kubectl apply -f azure-npm-windows.yaml
kubectl apply -f azure-npm-linux.yaml
